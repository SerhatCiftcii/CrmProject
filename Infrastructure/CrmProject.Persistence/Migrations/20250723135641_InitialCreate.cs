        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OldValue = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuthorizedPeople", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AuthorizedPeople_Customers_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContactLogs_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomerChangeLogs_AspNetUsers_ChangedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PassportCreatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ...
                    FirmSituation = table.Column<int>(type: "int", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    ExtendBy6Months = table.Column<bool>(type: "bit", nullable: false),
                    ExtendBy1Year = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MaintenanceProducts", x => new { x.MaintenanceId, x.ProductId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuthorizedPeople_CustomerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContactLogs_CustomerId",
                table: "ContactLogs",
                column: "CustomerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerChangeLogs_ChangedByUserId",
